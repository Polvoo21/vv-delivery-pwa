const PRODUCT_NUTRITION = {
  ...
  "breakfast-addon-smetana-30-g": { calories: 61, protein: 0.8, fat: 6, carbs: 1 },
  ...
  "breakfast-borodinskie-tosty-260-g": { calories: 656, protein: 21.3, fat: 44, carbs: 43.8 },
  "breakfast-draniki-kartofelnye-230-g": { calories: 801, protein: 21.2, fat: 62.5, carbs: 38.4 },
  "breakfast-glazunya-150-70-g": { calories: 571, protein: 14.3, fat: 47, carbs: 22.6 },
  ...
  "breakfast-poleznyy-zavtrak-280-g": { calories: 760, protein: 20.6, fat: 61.5, carbs: 31 },
  "breakfast-shakshuka-230-30-g": { calories: 436, protein: 10.9, fat: 29, carbs: 33 },
  ...
  "dessert-brauni": { calories: 732, protein: 9, fat: 44.2, carbs: 74.5 },
  "dessert-medovik": { calories: 250, protein: 3.1, fat: 14.1, carbs: 27.7 },
  "dessert-napoleon": { calories: 215, protein: 4.1, fat: 5.5, carbs: 37.4 },
  "drink-amerikano-250-ml": { calories: 40, protein: 0, fat: 0, carbs: 10 },
  "drink-amerikano-350-ml": { calories: 40, protein: 0, fat: 0, carbs: 10 },
  "drink-dvoynoy-kapuchino-350-ml": { calories: 173, protein: 7.2, fat: 6.2, carbs: 22 },
  "drink-espresso-40-ml": { calories: 40, protein: 0, fat: 0, carbs: 10 },
  ...
  "drink-kakao-200-ml": { calories: 90, protein: 3.5, fat: 3, carbs: 12.3 },
  ...
  "drink-raf-s-siropom-na-vybor-200-ml": { calories: 215, protein: 6.1, fat: 16.8, carbs: 10 },
  "drink-raf-s-siropom-na-vybor-350-ml": { calories: 215, protein: 6.1, fat: 16.8, carbs: 10 },
  "drink-smuzi-malina-chernika-imbir-300-ml": { calories: 143, protein: 2.4, fat: 1.1, carbs: 31 },
  ...
  "kids-krem-sup-iz-kurochki-240-20-g": { calories: 593, protein: 43.4, fat: 34.1, carbs: 28 },
  ...
  "main-steyk-ossobuko-260-120-50-g": { calories: 867, protein: 59.9, fat: 58, carbs: 26.5 },
  "main-svinye-rebryshki-480-g": { calories: 1833, protein: 60, fat: 165.2, carbs: 26.5 },
  ...
  "parmesan-focaccia": { calories: 847, protein: 28, fat: 31.7, carbs: 112.4 },
  ...
  "pasta-lapsha-domashnyaya-s-govyadinoy-340-g": { calories: 788, protein: 35.7, fat: 39, carbs: 73.4 },
  ...
  "salad-cezar-220-g": { calories: 506, protein: 27.8, fat: 35, carbs: 19.9 },
  "salad-nisuaz-270-g": { calories: 538, protein: 27.9, fat: 40.8, carbs: 14.7 },
  "salad-olive-s-govyadinoy-210-g": { calories: 500, protein: 17.7, fat: 44.1, carbs: 8 },
  "salad-salat-s-indeykoy-i-persikami-gril-230-g": { calories: 806, protein: 23.3, fat: 67.3, carbs: 26.8 },
  "salad-salat-s-lososem-220-g": { calories: 348, protein: 16, fat: 24.9, carbs: 14.7 },
  "salad-teplyy-salat-iz-telyatiny-240-g": { calories: 407, protein: 14.4, fat: 32.8, carbs: 13.6 },
  "salad-zelenyy-salat-280-g": { calories: 634, protein: 46.4, fat: 39.2, carbs: 24 },
  ...
  "side-ovoschi-gril-150-g": { calories: 281, protein: 5, fat: 21.4, carbs: 17.3 },
  ...
  "starter-zharenyy-syr-suluguni-180-30-g": { calories: 1217, protein: 46.4, fat: 95.4, carbs: 43 },
  "summer-beef-flatbread": { calories: 868, protein: 37.8, fat: 52.3, carbs: 61.5 },
  "summer-chicken-pear-salad": { calories: 918, protein: 34.5, fat: 79, carbs: 17.2 },
  ...
  "summer-okroshka-beef-kvass": { calories: 452, protein: 18, fat: 28.1, carbs: 31.6 },
...
const PUBLIC_HIDDEN_MENU_CATEGORY_IDS = /* @__PURE__ */ new Set(["breakfast-addon"]);
function isPublicMenuCategory(categoryId) {
...
function item({
  ...
  return {
    ...
    visual: visual || {
      image: resolvedImage,
      label: ((_a = categoryMap[category]) == null ? void 0 : _a.title) || name
    },
...
[
  ...
  ...MENU_CATEGORIES.filter((category) => isPublicMenuCategory(category.id)).map((category) => ({
    id: category.id,
...
export {
  MENU as M,
  MENU_CATEGORIES as a,
  MAP_CONFIG as b,
  isPublicMenuCategory as i
};
