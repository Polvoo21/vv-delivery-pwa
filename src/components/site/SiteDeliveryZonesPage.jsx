  ...
  return (
    <SitePublicShell className="site-delivery-zones-page">
      <section className="site-delivery-zones-hero">
        ...
        <span>
          Показываем районы Чебоксар, куда сейчас привозим заказы. В отмеченных зонах доставка пока бесплатная:
          мы только открылись и хотим, чтобы гостям было проще попробовать нас.
        </span>
        <div>
          <b>
            <MapPin size={16} />
      ...
      <section className="site-delivery-zones-layout">
        ...
        <aside className="site-delivery-zones-info">
          ...
          <p>
            Укажите адрес при заказе, и мы сразу покажем, доступна ли доставка. Сейчас все отмеченные зоны
            бесплатные. Если ваш адрес пока вне карты, всегда можно выбрать самовывоз с Пирогова, 1Т.
          </p>
          <ul>
            <li>В отмеченных районах доставка сейчас бесплатная.</li>
            <li>Точное время доставки показывается в корзине и на странице оформления.</li>
            <li>Самовывоз всегда доступен по адресу Пирогова, 1Т.</li>
