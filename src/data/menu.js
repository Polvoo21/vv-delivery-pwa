...
export const MENU = [
  ...
  item({ id: "margarita", category: "pizza", name: "Маргарита", description: "пицца с моцареллой и томатным соусом.", weight: "400 г", price: 640, ingredients: ["моцарелла","томатный соус"], featured: true }),
  item({ id: "pizza-carbonara", category: "pizza", name: "Карбонара", description: "пицца с беконом, моцареллой, пармезаном и сливочным соусом.", weight: "450 г", price: 690, ingredients: ["бекон","моцарелла","пармезан","сливочный соус"], featured: true }),
  item({ id: "pepperoni", category: "pizza", name: "Пеперони", description: "пицца с пепперони, моцареллой, соусом чимичурри и томатным соусом. Халапеньо по желанию.", weight: "500 г", price: 660, ingredients: ["пепперони","моцарелла","соус чимичурри","томатный соус"], featured: true }),
